...
import com.rigid.powertunes.BuildConfig;
...
//                    switch (clickCount) {
//                        case 1:
//                            command = MediaService.ACTION_TOGGLE_PAUSE;
//                            break;
//                        case 2:
//                            command = MediaService.ACTION_SKIP;
//                            break;
//                        case 3:
//                            command = MediaService.ACTION_REWIND;
//                            break;
//                        default:
//                            command = null;
//                            break;
...
//                    command = MediaService.ACTION_STOP;
//                    break;
...
//                    command = MediaService.ACTION_PAUSE;
//                    break;
//                case KeyEvent.KEYCODE_MEDIA_PLAY:
//                    command = MediaService.ACTION_PLAY;
//                    break;
//            }
            if (command != null) {
    ...
    private static void acquireWakeLockAndSendMessage(Context context, Message msg, long delay) {
        if (mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "POWERTUNES:headset button");
